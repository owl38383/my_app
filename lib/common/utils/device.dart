...
class DeviceInfoUtil {
  ...
  Future<void> initDeviceInfo() async {
    ...
    print(defaultTargetPlatform.runtimeType);
    try {
      if (kIsWeb) {
        ...
        _deviceData = switch (defaultTargetPlatform) {
          ...
          TargetPlatform.iOS =>
              _readIosDeviceInfo(await _deviceInfo.iosInfo),
          TargetPlatform.linux =>
              _readLinuxDeviceInfo(await _deviceInfo.linuxInfo),
          TargetPlatform.windows =>
              _readWindowsDeviceInfo(await _deviceInfo.windowsInfo),
          TargetPlatform.macOS =>
              _readMacOsDeviceInfo(await _deviceInfo.macOsInfo),
